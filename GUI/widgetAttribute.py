...
MENU_FIELD_ACTION_FILE              = "Файл".decode('utf-8')
...
MENU_FIELD_OPEN_FILE                = "открыть файл".decode('utf-8')
MENU_FIELD_CLOSE_FILE               = "закрыть файл".decode('utf-8')
MENU_FIELD_SAVE_AS_FILE             = "сохранить как".decode('utf-8')
MENU_FIELD_EXIT_APP                 = "выход".decode('utf-8')
MENU_FIELD_EDIT_RECORD              = "редактировать записи".decode('utf-8')
